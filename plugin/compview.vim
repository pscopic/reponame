...
"
"               The following keys are mapped to the resutls window:
"
...
function! s:SearchFile(word)
    ...
    " Search at the begining and keep adding them to the register
    normal gg
...
function! s:CSearch()
    ...
    " updat the doc and hook the CheckForUpdate function.
    call <sid>UpdateDoc()
